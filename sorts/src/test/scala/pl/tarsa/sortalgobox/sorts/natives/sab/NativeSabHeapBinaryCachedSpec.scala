...
class NativeSabHeapBinaryCachedSpec extends NativesUnitSpecBase {
  typeBehavior[NativeSabHeapBinaryCached]

  it should "sort and validate" in {
    val sort = new NativeSabHeapBinaryCached(testNativesCache)
