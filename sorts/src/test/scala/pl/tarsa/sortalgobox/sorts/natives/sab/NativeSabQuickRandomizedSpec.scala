...
class NativeSabQuickRandomizedSpec extends NativesUnitSpecBase {
  typeBehavior[NativeSabQuickRandomized]

  it should "sort and validate" in {
    val sort = new NativeSabQuickRandomized(testNativesCache)
