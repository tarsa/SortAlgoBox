 ...
 *
 */
package pl.tarsa.sortalgobox.sorts.shell

import pl.tarsa.sortalgobox.sorts.SortChecker
import pl.tarsa.sortalgobox.tests.CommonUnitSpecBase

class ShellSortSpec extends CommonUnitSpecBase {
  typeBehavior[ShellSort[_]]

  def intSort = new ShellSort[Int](TokudaGapSequence)
