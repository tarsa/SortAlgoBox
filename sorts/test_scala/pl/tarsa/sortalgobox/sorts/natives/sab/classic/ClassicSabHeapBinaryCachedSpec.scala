...
class ClassicSabHeapBinaryCachedSpec extends NativesUnitSpecBase {
  typeBehavior[ClassicSabHeapBinaryCached]

  it must "sort and validate" in {
    val sort = new ClassicSabHeapBinaryCached(testNativesCache)
