...
class ClassicSabQuickRandomizedSpec extends NativesUnitSpecBase {
  typeBehavior[ClassicSabQuickRandomized]

  it must "sort and validate" in {
    val sort = new ClassicSabQuickRandomized(testNativesCache)
