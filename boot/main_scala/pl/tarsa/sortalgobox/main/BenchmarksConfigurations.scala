...
object BenchmarksConfigurations {
  ...
  val nativeBenchmarks: List[NativeBenchmark] =
    List(
      ...
      new ClassicSabHeapHybrid(),
      new ClassicSabHeapHybridCascading(),
      new ClassicSabHeapQuaternaryCascadingVariantA(),
      new ClassicSabHeapQuaternaryVariantA(),
      new ClassicSabHeapQuaternaryVariantB(),
      ...
      new ClassicSabHeapTernaryCascadingVariantA(),
      new ClassicSabHeapTernaryClusteredVariantA(),
      new ClassicSabHeapTernaryClusteredVariantB(),
