 ...
 *
 */
package pl.tarsa.sortalgobox.sorts.radix

import pl.tarsa.sortalgobox.sorts.SortChecker
import pl.tarsa.sortalgobox.tests.CommonUnitSpecBase

class RadixSortSpec extends CommonUnitSpecBase {
  typeBehavior[RadixSort[_]]

  import pl.tarsa.sortalgobox.sorts.common.ExSituAlgorithm._
  def intSort = new RadixSort[Int]
