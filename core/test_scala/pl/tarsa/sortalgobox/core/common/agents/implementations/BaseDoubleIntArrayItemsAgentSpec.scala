...
abstract class BaseDoubleIntArrayItemsAgentSpec[AgentType <: ItemsAgent[_]](
    builder: (Array[Int], Array[Int]) => AgentType)
  ...
  def writeTest(inputItems: Int*)(inputBufferItems: Int*)(
      operations: (AgentType => Unit)*)(outputItems: Int*)(
      outputBufferItems: Int*) {
